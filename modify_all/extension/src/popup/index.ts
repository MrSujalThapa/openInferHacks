type PopupEditModeState = "off" | "hovering";
...
const statusNode: HTMLElement = statusElement;
...
async function sendMessage(
  ...
  return new Promise((resolve, reject) => {
    chrome.tabs?.sendMessage(tabId, message, (response) => {
      ...
      resolve(response as PopupRuntimeResponse);
    });
  });
}

function setUi(enabled: boolean, message?: string): void {
